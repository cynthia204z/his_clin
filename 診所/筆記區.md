...
**usageOei 適用開立部門**：但是診所應該沒有急住差別，所以暫時判斷先不開這個欄位
...
​		  <span style="padding:6px;border:gray 1px solid;"><font style="font-weight:800;">從外部取得：</font>   <font style="background:#272727;padding:1px 6px;color:#eee;border-radius:5px;">用途類別 xmlTypeNcid (醫師/科別--常用/套餐)</font> + <font style="background:#272727;padding:1px 6px;color:#eee;border-radius:5px;">使用單元別 ownerNcid (醫師/科別代碼)</font></span>

​	=>  <span style="padding:6px;border:gray 1px solid;"><font style="font-weight:800;">從下拉取得：</font>   <font style="background:#2;padding:1px 6px;color:#eee;border-radius:5px;">次用途類別 xmlSubTypeNcid (ICD10、PKG、EXAM、NOTE...)</font></span>

​	=>  <font style="padding:3px 6px; border:1px solid gray">產生頂級目錄名稱 xmlName</font> EX: ` ‵個人常用(${對應的次用途類別名})‵ ` + <font style="padding:3px 6px; border:1px solid gray">使用分類 fillerSysNcid</font>
